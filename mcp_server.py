"""
MCP Server for Breast Histopathology Cancer Detection
...
app = Server("breast-patho-mcp-server")

# Paths
MODELS_DIR = Path("models")
MODEL_PATH = MODELS_DIR / "histopathology_model.h5"

# Global model
model = None
CLASSES = ['No Cancer', 'IDC (+) Cancer']
INPUT_SHAPE = (50, 50, 3)
...
async def list_tools() -> List[Tool]:
    ...
    return [
        Tool(
            name="predict",
            description="Make a prediction using the Breast Histopathology Cancer Detection model. Input should be a file path to an image or base64 encoded image.",
            inputSchema={
                "type": "object",
                "properties": {
                    "input": {
...
async def call_tool(name: str, arguments: Dict[str, Any]) -> List[TextContent]:
    ...
    if name == "health_check":
        ...
        info = {
            ...
            "description": "Breast Histopathology Cancer Detection"
        }
