...
# Example: Histopathology Cancer Detection
import requests

# Upload histopathology image
with open("histopathology_image.jpg", "rb") as f:
    files = {"file": f}
...
```json
{
  "mcpServers": {
    "breast-patho": {
      "command": "python",
      "args": ["/home/m-aljasem/projects/ai-projects/breast-patho/mcp_server.py"],
      "env": {
        "PYTHONPATH": "/home/m-aljasem/projects/ai-projects/breast-patho"
      }
    }
  }
}
